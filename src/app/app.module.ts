...
import { ChordService, BassService } from './bass.service';
...
@NgModule({
  ...
  providers: [ChordService, BassService], // list of dependency injection providers visible to this and any importers of this module
